...
{
	 DUBUG_LOG(@"Now you are in Concatenate method in JiwokMusicProcessor class");
	if(![inputArray count])
		return;
	...
	if(!([secondInputExtension isEqualToString:@"wav"]||[firstInputExtension isEqualToString:@"wav"]))		
	{
	 ...
	 DUBUG_LOG(@"Now you are completed Concatenate method in JiwokMusicProcessor class");
}
...
{
	 DUBUG_LOG(@"Now you are in ChangeVolume method in JiwokMusicProcessor class");
...
/*	if(!([firstInput isEqualToString:inputFile]))
	...
	DUBUG_LOG(@"Now you are completed ChangeVolume method in JiwokMusicProcessor class");
...
{	
     DUBUG_LOG(@"Now you are in MixAudio method in JiwokMusicProcessor class");
	NSString *firstInputExtension=[inputFile1 substringFromIndex:([inputFile1 length]-3)];
	NSString *secondInputExtension=[inputFile2 substringFromIndex:([inputFile2 length]-3)];	
	...
	DUBUG_LOG(@"Now you are completed MixAudio method in JiwokMusicProcessor class");
}

- (void)convertBitRate:(NSString*)inputFile:(NSString*)Bitrate:(NSString*)outputFile
{	
    DUBUG_LOG(@"Now you are in convertBitRate method in JiwokMusicProcessor class");
	...
	DUBUG_LOG(@"Now you are completed convertBitRate method in JiwokMusicProcessor class");
}


- (void)PadSilence:(NSString*)inputFile:(NSString*)outputFile:(NSString*)startupPadding:(NSString*)EndPadding
{	
    DUBUG_LOG(@"Now you are in PadSilence method in JiwokMusicProcessor class");
	NSString *firstInputExtension=[inputFile substringFromIndex:([inputFile length]-3)];
	NSString *firstInput;
	...
	if(!([firstInputExtension isEqualToString:@"wav"]))		
	{
	 ...
	 DUBUG_LOG(@"Now you are completed PadSilence method in JiwokMusicProcessor class");
}


- (void)TrimAudio:(NSString*)inputFile:(NSString*)outputFile:(NSString*)startPosition:(NSString*)Length
{	
    DUBUG_LOG(@"Now you are in TrimAudio method in JiwokMusicProcessor class");
	NSString *firstInputExtension=[inputFile substringFromIndex:([inputFile length]-3)];
	NSString *firstInput;
	...
	DUBUG_LOG(@"Now you are completed TrimAudio method in JiwokMusicProcessor class");
}


-(BOOL)isValidSoxFile:(NSString*)inputFile{
    
	DUBUG_LOG(@"Now you are in isValidSoxFile method in JiwokMusicProcessor class");
	NSString * toolPath;	
	...
	DUBUG_LOG(@"Now you are completed isValidSoxFile method in JiwokMusicProcessor class");
	return result;
