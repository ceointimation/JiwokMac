...
float BPMDetect::getBpm()
{
	...
	printf("\n peakPos peakPos is ||%f| \n",peakPos);
	
		//printf("peakPos peakPos is ||%f|| sampleRate is |%f| decimateBy is |%f| XXXXX is |%f|",peakPos,sampleRate,decimateBy,(float)(60.0 * (((double)sampleRate / (double)decimateBy) / peakPos)));
